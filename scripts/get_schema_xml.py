...
if __name__ == "__main__":
    ...
    db_path = os.getenv("DUCKDB_DATABASE") or os.path.join(
        project_root, "data", "nyc_database.duckdb"
    )
    output_path = os.getenv("DUCKDB_SCHEMA_XML") or os.path.join(
        project_root, "data", "nyc_db_schema.xml"
    )
