...
SELECT
    ...
    avg_tip_per_trip,
    avg_total_per_trip,
    fare_percent_of_total,
    tip_percent_of_total,
    fees_percent_of_total,
    tolls_percent_of_total,
    credit_card_revenue,
    cash_revenue,
    credit_card_percent,
    cash_percent,
    ...
    peak_trips,
    off_peak_trips,
    peak_revenue_percent,
    off_peak_revenue_percent,
    peak_trips_percent,
    off_peak_trips_percent,
    avg_fare_per_peak_trip,
    avg_fare_per_off_peak_trip,
    peak_to_off_peak_fare_ratio,
    morning_rush_revenue,
    midday_revenue,
    evening_rush_revenue,
    evening_revenue,
    late_night_revenue,
    morning_rush_revenue_percent,
    midday_revenue_percent,
    evening_rush_revenue_percent,
    evening_revenue_percent,
    late_night_revenue_percent,
    rush_to_non_rush_revenue_ratio
