...
BRONZE_LISTEN_EVENTS_SCHEMA = StructType(
    LISTEN_EVENTS_SCHEMA.fields + META_SCHEMA
)

BRONZE_PAGE_VIEW_EVENTS_SCHEMA = StructType(
    PAGE_VIEW_EVENTS_SCHEMA.fields + META_SCHEMA
)

BRONZE_AUTH_EVENTS_SCHEMA = StructType(
    AUTH_EVENTS_SCHEMA.fields + META_SCHEMA
)
